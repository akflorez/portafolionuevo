        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto w-full">
          {firstRow.map((service, index) => (
            <motion.div
              ...
              className="card-glass p-6 rounded-[2rem] border border-white/5 group relative flex flex-col justify-between min-h-[14rem] transition-all duration-300 hover:border-emerald-500/20 hover:bg-emerald-500/[0.02]"
            >
