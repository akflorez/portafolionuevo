...
const Slide4Contact = () => (
  <SlideLayout bgImage={slide4Bg} overlayStrong>
    ...
    >
      ...
      <motion.p className="text-xl text-primary-foreground/60 mb-16 font-light max-w-xl" variants={item}>
        Registra con quién se sostuvo la gestión.
      </motion.p>
      <motion.div className="flex gap-8 max-w-3xl" variants={container}>
        <motion.div
          className="card-glass-strong rounded-2xl p-10 flex-1 flex flex-col items-center text-center gap-5 glow-green"
          variants={item}
        >
        ...
        <motion.div
          className="card-glass rounded-2xl p-10 flex-1 flex flex-col items-center text-center gap-5"
          variants={item}
        >
