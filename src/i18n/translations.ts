...
export const translations = {
  en: {
    ...
    slide4SuccessCases: {
      ...
      block1_item1: "Client portfolio",
      block1_item2: "Contact channels",
      block1_item3: "Management history",
      block1_item4: "Segmentation",
      block2_title: "Smart Operation",
      block2_surround1: "AI Support",
      block2_surround2: "Human agents",
      block2_surround3: "Prioritization",
      block2_surround4: "Monitoring",
      block2_surround5: "Indicator control",
      block2_callout_title: "AI + specialized human agents",
      block2_callout_text: "AI supports prioritization and analysis; human agents lead management, negotiation, and client relations.",
      block3_title: "Measurable Results",
      kpi1_title: "Contactability Rate",
      kpi1_desc: "Measurement of the contact level achieved over the managed database.",
      kpi2_title: "Conversion Rate",
      kpi2_desc: "Monitoring of the percentage of interactions transformed into effective results.",
      kpi3_title: "Effectiveness Rate",
      kpi3_desc: "Comprehensive indicator of the operational performance on the portfolio worked.",
  ...
  es: {
    ...
    slide4SuccessCases: {
      ...
      block1_item1: "Cartera de clientes",
      block1_item2: "Canales de contacto",
      block1_item3: "Historial de gestión",
      block1_item4: "Segmentación",
      block2_title: "Operación Inteligente",
      block2_surround1: "Apoyo de IA",
      block2_surround2: "Agentes humanos",
      block2_surround3: "Priorización",
      block2_surround4: "Seguimiento",
      block2_surround5: "Control de indicadores",
      block2_callout_title: "IA + agentes humanos especializados",
      block2_callout_text: "La IA apoya la priorización y el análisis; los agentes humanos lideran la gestión, la negociación y la relación con el cliente.",
      block3_title: "Resultados Medibles",
      kpi1_title: "Tasa de contactabilidad",
      kpi1_desc: "Medición del nivel de contacto logrado sobre la base gestionada.",
      kpi2_title: "Tasa de conversión",
      kpi2_desc: "Seguimiento al porcentaje de interacciones que se transforman en resultados efectivos.",
      kpi3_title: "Tasa de efectividad",
      kpi3_desc: "Indicador integral del desempeño de la operación sobre el portafolio trabajado.",
